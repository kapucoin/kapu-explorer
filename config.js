...
config.exchangeRates.exchanges.KAPU.BTC = 'poloniex';  // KAPU/BTC pair, supported: poloniex
config.exchangeRates.exchanges.KAPU.CNY = 'jubi';      // KAPU/CNY pair, supported: jubi, bitbays
